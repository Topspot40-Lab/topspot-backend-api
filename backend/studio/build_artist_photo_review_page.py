...
def build_page(
    *,
    ...
    print()
    print("TOPSPOT STUDIO â€” ARTIST PHOTO RESEARCH")
    print("=" * 70)
...
<section class="card">
  <div class="heading">
    ...
    <span>{candidate.width} Ã— {candidate.height}</span>
  </div>
...
<head>
<meta charset="utf-8">
<title>{escape(artist_name)} â€” Artist Photo Research</title>
<style>
  body {{
    margin: 0;
    padding: 2rem;
...
<body>
<h1>{escape(artist_name)} â€” Artist Photo Research</h1>
